...
public class ConjuntoEspalhamento {
	...
	public void adiciona(String palavra) {
		if(!this.contem(palavra)) { //evitar a repetição de palavras fazendo uma pequena verificação antes de adicionar uma palavra.
			this.verificaCarga();
	...
	/*
	private int calculaIndiceDaTabela2(String palavra) {
		int codigoDeEspelhamento = this.calculaCodigoDeEspalhamento(palavra);
		codigoDeEspelhamento = Math.abs(codigoDeEspelhamento); //evitar gerar um numero negativo
