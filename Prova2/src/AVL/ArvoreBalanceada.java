// Natália Sales Aragão - 1461765S
// Seguinte, vou ter q refutar a questão pois as duas árvores não são AVL, as duas precisaram rotacionar,
// o que significa que precisam se balancear para se tornar AVL.
package AVL;
...
public class ArvoreBalanceada<T extends Comparable<T>> {
	...
	public int isAVL() {
		if( getQuantRotacoes() > 1 ) { //se houve rotação, a arvore original não é uma AVL
			return 0;
		}else {
			return 1;
		}
	...
	public static void main(String[] args) {
		ArvoreBalanceada<Integer> arvore = new ArvoreBalanceada<Integer>();
		
		Scanner scan = new Scanner(System.in);
		System.out.println("Digite o número de elementos da árvore");
		int elementos = scan.nextInt();
		if( elementos > 0 && elementos < 1000) {
			System.out.println("Digite os elementos da arvore");
			while(true) {
			...
			System.out.println("Árvore pré ordenada: ");
